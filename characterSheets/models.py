        ...
        if self.other:
            if self.base + self.other + self.spellRange.level + self.spellDuration.level + self.spellTarget.level > 5:
                if self.base >= 5:
                    ...
                    return self.base + (self.spellRange.level + self.spellDuration.level + self.spellTarget.level + self.other - (5 - self.base)) * 5 + 5
            else:
            ...
            if self.base + self.spellRange.level + self.spellDuration.level + self.spellTarget.level > 5:
                if self.base >= 5:
                    ...
                    return self.base + (self.spellRange.level + self.spellDuration.level + self.spellTarget.level - (5 - self.base)) * 5 + 5
            else:
