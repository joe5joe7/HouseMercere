...
urlpatterns = [
    ...
    path('sourceset/spells/<int:pk>/guidelines/<str:f>/<str:t>', views.sourceset_guideline,
         name='sourceset-spells-guideline'),
    path('sourceset/spells/<int:pk>/guidelines/<int:guideline>', views.source_guidelines_import,
         name='sourceset-spells-import'),
    ...
    path('sourceset/spells/<int:pk>/addspell/<int:guideline>', views.source_guideline_addSpell,
         name='sourceset-add-spell'),
    path('sourceset/spells/<int:pk>/importSpells/<int:guideline>', views.source_guideline_import_spells,
         name='import-spells'),
]
