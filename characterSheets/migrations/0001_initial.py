...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': {('source_owner', 'Owner'), ('source_can_view', 'Can View'), ('source_can_edit', 'Can Edit')},
            },
        ),
        migrations.CreateModel(
            name='VF',
            fields=[
                ...
                ('description', models.TextField(help_text='Virtue or flaw Description', max_length=10000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('e', 'equipped'), ('c', 'carried'), ('s', 'stored')], default='c', max_length=1)),
                ('description', models.CharField(blank=True, max_length=200, null=True)),
                ('ownerChar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='characterSheets.character')),
                ('ownerCovenant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='characterSheets.covenant')),
                ('referenceWeapon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='characterSheets.weapon')),
            ],
        ),
        migrations.CreateModel(
            name='VirtueInstance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sourceSets', models.ManyToManyField(blank=True, to='characterSheets.SourceSet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownerChar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='characterSheets.character')),
                ('ownerCovenant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='characterSheets.covenant')),
                ('referenceEquip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='characterSheets.miscequip')),
            ],
        ),
        migrations.AddField(
            model_name='miscequip',
            name='source',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('abi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='characterSheets.ability')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownerChar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='characterSheets.character')),
                ('ownerCovenant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='characterSheets.covenant')),
                ('referenceArmor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='characterSheets.armor')),
            ],
        ),
        migrations.AddField(
            model_name='armor',
